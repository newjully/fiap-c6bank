...
<TextField margin="normal" required fullWidth id="nome" label="Digiete o nome" name="nome" autoComplete="nome" autoFocus />  
...
<TextField margin="normal" required fullWidth id="passwordValida" label="Repita a mesma senha" name="passwordValida" autoComplete="passwordValida" autoFocus />
